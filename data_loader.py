...
val_idex = tl.utils.get_random_int(min_v=0,
                                   max_v=train_all_num - 1,
                                   number=val_num,
                                   seed=seed)
...
for fi, f in enumerate(f_train):
    ...
    for i in range(img.shape[2]):
        img_2d = img[:, :, i]
        # filter out 2d images containing < 35% non-zeros
